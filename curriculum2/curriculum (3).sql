...
--
-- Hôte : 127.0.0.1
-- Généré le :  mer. 16 jan. 2019 à 13:16
...
CREATE TABLE `activities` (
  ...
  `desc_act` varchar(45) CHARACTER SET utf8mb4 DEFAULT NULL,
...
CREATE TABLE `exp_pro` (
  ...
  `location_exp` varchar(45) CHARACTER SET utf8mb4 DEFAULT NULL,
  `job_exp` varchar(45) CHARACTER SET utf8mb4 DEFAULT NULL,
...
CREATE TABLE `realisations` (
  ...
  `desc_rea` varchar(45) CHARACTER SET utf8mb4 DEFAULT NULL,
...
CREATE TABLE `skills` (
  ...
  `desc_skill` varchar(45) CHARACTER SET utf8mb4 DEFAULT NULL,
  `users_id_users` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `trainings` (
  ...
  `location_train` varchar(45) CHARACTER SET utf8mb4 DEFAULT NULL,
  `title_train` varchar(45) CHARACTER SET utf8mb4 DEFAULT NULL,
  `dipl_name_train` varchar(45) CHARACTER SET utf8mb4 DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `address_user` varchar(45) CHARACTER SET utf8mb4 DEFAULT NULL,
  ...
  `obj_career_user` longtext CHARACTER SET utf8mb4,
...
--
ALTER TABLE `exp_pro`
  MODIFY `id_exp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `trainings`
  MODIFY `id_train` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
